---
title: MySQL 索引基础知识详解-01 索引概念及其用途
---

# 小谭充电屋 | 索引基础知识详解-01 索引概念及其用途

## 什么是索引？
**专业定义：** 索引是帮助 `MySQL` 高效获取数据的**有序**的**数据结构。**
**通俗定义：** 类似于我们纸质书籍中的目录，拿汉语字典的目录页（索引）打比方，我们可以按拼音、笔画、偏旁部首等排序的目录（索引）快速查找到需要的字。

对于 `MySQL` 来说，那就是在查询数据时利用索引进行快速定位到我们需要的数据，从而达到缩短时间、提高性能的目的。
