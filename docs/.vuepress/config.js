  ...
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "小谭，小谭充电屋, 编程语言，开发技术，MySQL，JVM技术，MySQL，框架源码。。。",
      },
    ],
    [
      "meta",
        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              {
                text: "MySql 索引",
                link: "/md/MySql/index/default.md",
              },
              {
                text: "事务",
          ...
          },
          {
            ...
            items: [
              {
                text: "初级-发轫之始",
                link: "/md/cat4j-boot/elementary/default.md",
              },
              {
                text: "中级-渐入佳境",
                link: "/md/cat4j-boot/middle-rank/default.md",
              },
              {
                text: "高级-走火入魔",
                link: "/md/cat4j-boot/high-rank/default.md",
              },
            ],
          },
          {
...
function getMySqlIndex() {
  return [
    ...
    },
    {
      ...
      sidebarDepth: 2,
      children: [
        "majorization/majorization-01.md",
      ],
    },
    {
      title: "MySQL 索引优化实战",
      ...
      sidebarDepth: 2,
      children: [
        "actual_combat/actual_combat-01.md",
      ],
    },
  ];
}
...
function getBarCat4JBootElementtary() {
  return [
    {
      title: "cat4j-boot | 初级-发轫之始",
      collapsable: false,
      sidebarDepth: 2,
      children: ["default.md"],
    },
